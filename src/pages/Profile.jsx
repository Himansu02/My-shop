        ...
        <div className="userShow">
          ...
          <div className="userShowBottom">
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">{user?.dob ? user?.dob : "N/A"}</span>
            </div>
            <span className="userShowTitle">Contact Details</span>
            <div className="userShowInfo">
              <PhoneAndroid className="userShowIcon" />
              <span className="userShowInfoTitle">{user?.number ? user?.number : "N/A"}</span>
            </div>
            <div className="userShowInfo">
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">{user?.address ? user?.address : "N/A"}</span>
            </div>
          </div>
        </div>
